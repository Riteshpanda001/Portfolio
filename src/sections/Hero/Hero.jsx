...
import { SITE_NAME, SITE_ROLE, SOCIAL_LINKS } from '../../utils/constants';
import './Hero.css';
      ...
      <div className="container hero__content">
        ...
        <div className="hero__text">
          ...
          <p className="hero__role animate-fadeInUp" style={{ animationDelay: '0.2s' }}>
            <span className="hero__role-text">{SITE_ROLE}</span>
          </p>

          <p className="hero__subtitle animate-fadeInUp" style={{ animationDelay: '0.3s' }}>
            I craft scalable, elegant web applications with modern technologies.
